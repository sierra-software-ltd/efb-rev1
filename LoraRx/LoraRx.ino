/******************************************************************************
* Copyright (C) 2018, SIERRA SOFTWARE LTD.,Ltd All rights reserved.
*
* This software is owned and published by SSLA
*
 ...
 **
 **   - 2019-2-18  1.0  XYZ First version for Device Driver Library of Module.
 **
 ******************************************************************************/
...
// i = bSpiRead(0x42);
//  Serial.println("device RegVersion : ");
//  Serial.println(i);
}
