...
static	FreqStruct FrequencyValue;
static	word BitRateValue;
static	word DevationValue;
static	byte BandWidthValue;
static	byte SFValue;
static	byte BWValue;
static	byte CRValue;
static	byte RsOptimize;
